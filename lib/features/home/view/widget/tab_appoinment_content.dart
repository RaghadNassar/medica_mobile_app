...
class TabAppointmentContent extends GetView<DoctorBookingController> {
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                       Text(StringManager.anathoreperson.tr),
                    ],
                  ),
                ),
              ),
          ...
          return Form(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: context.heightPct(0.03)),
                Text(
                  StringManager.newpatintinfo.tr,
                  style: theme.textTheme.bodyMedium?.copyWith(fontSize: 16, fontWeight: FontWeight.bold),
                ),
                SizedBox(height: context.heightPct(0.02)),
 ...
 /* String _getArabicDayName(DateTime date) {
  switch (date.weekday) {
    ...
    case DateTime.wednesday: return StringManager.wednesday.tr;
    case DateTime.thursday: return StringManager.thursday.tr;
    case DateTime.friday: return StringManager.friday.tr;
    case DateTime.saturday: return StringManager.saturday.tr;
