...
class AppointmentResponse {
  final String message;
  final bool? success; // أضفنا حقل نجاح العملية للرد الجديد
  final AppointmentModel? appointment;
  final PatientDataModel? patientData; // أضفنا كائن بيانات المريض الجديد هنا
  ...
  factory AppointmentResponse.fromJson(Map<String, dynamic> json) {
    return AppointmentResponse(
      ...
      appointment: json[ApiKey.appointment] != null 
          ? AppointmentModel.fromJson(json[ApiKey.appointment]) 
          : null,
      // إذا كان الرد يحتوي على patient_data (حجز لغيري) سنقوم بعمل Parse له هنا
...
// كلاس فرعي نظيف لبيانات المريض الجديد المسترجعة في الـ Response
